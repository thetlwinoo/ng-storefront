...
import '@box/components/highlight/prism-languages';
...
export class BoxHighlightComponent implements OnInit, OnDestroy
{
    // Source
    @ContentChild('source')
    source: ElementRef;
    ...
    highlight(sourceCode): void
    {
        ...
        // can be formatted properly while using box-highlight
        // component
