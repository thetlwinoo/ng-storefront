...
import { MatColors } from '@box/mat-colors';
import { ControlValueAccessor, NG_VALUE_ACCESSOR } from '@angular/forms';

export const BOX_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR: any = {
    provide    : NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => BoxMaterialColorPickerComponent),
    multi      : true
};

@Component({
    selector     : 'box-material-color-picker',
    templateUrl  : './material-color-picker.component.html',
    styleUrls    : ['./material-color-picker.component.scss'],
    animations   : boxAnimations,
    encapsulation: ViewEncapsulation.None,
    providers    : [BOX_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR]
})
export class BoxMaterialColorPickerComponent implements ControlValueAccessor
{
    colors: any;
    hues: string[];
    view: string;
    ...
    set color(value)
    {
        ...
        // Split the color value (red-400, blue-500, box-navy-700 etc.)
