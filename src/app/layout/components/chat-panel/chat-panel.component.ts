...
export class ChatPanelComponent implements OnInit, AfterViewInit, OnDestroy
{
    ...
    @ViewChildren(BoxPerfectScrollbarDirective)
    private _boxPerfectScrollbarDirectives: QueryList<BoxPerfectScrollbarDirective>;

    // Private
    private _chatViewScrollbar: BoxPerfectScrollbarDirective;
    ...
    ngOnInit(): void
    {
        ...
        this._boxSidebarService.getSidebar('chatPanel').foldedChanged
    ...
    {
        this._chatViewScrollbar = this._boxPerfectScrollbarDirectives.find((directive) => {
    ...
    {
        this._boxSidebarService.getSidebar('chatPanel').foldTemporarily();
    }
    ...
    {
        this._boxSidebarService.getSidebar('chatPanel').unfoldTemporarily();
    }
    ...
    {
        this._boxSidebarService.getSidebar('chatPanel').toggleOpen();
    }
