import { BoxNavigation } from '@box/types';

export const navigation: BoxNavigation[] = [
    {
        id       : 'applications',
        title    : 'Applications',
                ...
                children: [
                    {
                        ...
                        title: 'Server',
                        type : 'item',
                        url  : '/documentation/working-with-box/server'
                    },
                    {
                        id   : 'production',
                        title: 'Production',
                        type : 'item',
                        url  : '/documentation/working-with-box/production'
                    },
                    {
                        id   : 'directory-structure',
                        title: 'Directory Structure',
                        type : 'item',
                        url  : '/documentation/working-with-box/directory-structure'
                    },
                    {
                        id   : 'updating-box',
                        title: 'Updating Box',
                        type : 'item',
                        url  : '/documentation/working-with-box/updating-box'
                    },
                    {
                        id   : 'multi-language',
                        title: 'Multi Language',
                        type : 'item',
                        url  : '/documentation/working-with-box/multi-language'
                    },
                    {
                        id   : 'material-theming',
                        title: 'Material Theming',
                        type : 'item',
                        url  : '/documentation/working-with-box/material-theming'
                    },
                    {
                        id   : 'theme-layouts',
                        title: 'Theme Layouts',
                        type : 'item',
                        url  : '/documentation/working-with-box/theme-layouts'
                    },
                    {
                        id   : 'page-layouts',
                        title: 'Page Layouts',
                        type : 'item',
                        url  : '/documentation/working-with-box/page-layouts'
                    }
                ]
            },
            {
                ...
                children: [
                    {
                        ...
                        title: 'boxIfOnDom',
                        type : 'item',
                        url  : '/documentation/directives/box-if-on-dom'
                    },
                    {
                        id   : 'box-inner-scroll',
                        title: 'boxInnerScroll',
                        type : 'item',
                        url  : '/documentation/directives/box-inner-scroll'
                    },
                    {
                        id   : 'box-mat-sidenav',
                        title: 'boxMatSidenav',
                        type : 'item',
                        url  : '/documentation/directives/box-mat-sidenav'
                    },
                    {
                        id   : 'box-perfect-scrollbar',
                        title: 'boxPerfectScrollbar',
                        type : 'item',
                        url  : '/documentation/directives/box-perfect-scrollbar'
                    }
                ]
            },
            {
                ...
                children: [
                    {
                        ...
                        title: 'Box Config',
                        type : 'item',
                        url  : '/documentation/services/box-config'
                    },
                    {
                        id   : 'box-splash-screen',
                        title: 'Box Splash Screen',
                        type : 'item',
                        url  : '/documentation/services/box-splash-screen'
                    }
                ]
            }
        ]
